...
import com.flir.flironeexampleapplication.live_chat.LiveFragShow;
import com.flir.flironeexampleapplication.live_chat.LiveLoginActivity;
 ...
 */
public class PreviewActivity extends AppCompatActivity implements Device.Delegate, FrameProcessor.Delegate, Device.StreamDelegate, Device.PowerUpdateDelegate{
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try{
                       ...
                       Toast toast = Toast.makeText(actme,
                                "cam albert", Toast.LENGTH_SHORT);
                        toast.show();
...
//start the activity for emergency request to doctor
                    Intent i = new Intent(actme,
                            LiveFragShow.class);
    ...
    public void onCaptureImageClicked(View v){
        ...
        if(flirOneDevice == null && lastSavedPath != null) {
            ...
            Toast toast = Toast.makeText(actme,
                    "request true", Toast.LENGTH_SHORT);
